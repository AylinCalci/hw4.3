...
public class UserManager implements UserService {
	...
	public void updateEmail(User user, String newEmail, String password) {
		if(user.getPassword()==password) {
			...
			System.out.println(user.getFirstName()+" Mailiniz deðiþtirildi");
		}
		else {
	...
	public void addMoney(User user, int amount) {
		...
		System.out.println(user.getFirstName()+" Cüzdanýnýza "+amount+"lira eklendi");
		
	}

	@Override
	public void showMoney(User user) {
		System.out.println(user.getFirstName()+" Cüzdanýnýzda "+logger.showMoney(user)+"lira bulunuyor");
